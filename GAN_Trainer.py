...
gen = GAN.Generator(featur., es_g).to(device)
disc = GAN.Discriminator(features_d).to(device)
optimizer_gen = torch.optim.Adam(gen.parameters(), lr=learningRate)
optimizer_disc = torch.optim.Adam(disc.parameters(), lr=learningRate)
