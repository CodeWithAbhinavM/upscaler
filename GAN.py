...
class Pictures(Dataset):
    def __init__(self) -> None:
        imagePaths = listdir("Downloads/Upscaler-master/Upscaler-master/cats")
        ...
        for i in range(self.length):
            self.images[i] = np.array(Image.open("Downloads/Upscaler-master/Upscaler-master/cats/" + imagePaths[i]).resize((256, 256)))
            self.resized_images[i] = np.array(Image.open("Downloads/Upscaler-master/Upscaler-master/cats/" + imagePaths[i]))
